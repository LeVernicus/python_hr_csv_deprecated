...
# Below is the python program for getting training data online from CSV reports generated by Public Schoolworks 
...
def get_csv():
    ...
    loginpage = 'https://www.publicschoolworks.com/LMS/Login/login.php?di=541&dia=s326w&url=http%3A%2F%2Fwww.publicschoolworks.com%2FLMS%2FlmsStudentView.php%3Flanding%3Dmycoursepage&'
    reports_urls = [ 
    'https://www.publicschoolworks.com/LMS/Reports/lmsReportAllTranscripts.php?site=0&occ=27658&dept=0&emp=0&cid=0&grade=1&s_date='+ s_date +'&e_date='+ e_date +'&include_inactive_only=0&do_csv=2',
    'https://www.publicschoolworks.com/LMS/Reports/lmsReportAllTranscripts.php?site=0&occ=27658&dept=0&emp=0&cid=0&grade=1&s_date='+ s_date +'&e_date='+ e_date +'&include_inactive_only=1&do_csv=2',
    'https://www.publicschoolworks.com/LMS/Reports/lmsReportAllTranscripts.php?site=0&occ=43092&dept=0&emp=0&cid=0&grade=1&s_date='+ s_date +'&e_date='+ e_date +'&include_inactive_only=0&do_csv=2',
    ]
